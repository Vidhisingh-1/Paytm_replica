...
export function Appbar ({firstName})
{
    ...
    return (
        <div className = "font-semibold flex justify-between items-center h-[50px] border border-b-2 border-green-400" >
            <div className = "pl-4" >
                Pay
            </div>
            <div className = "flex pr-4 w-[150px] justify-around" >
                ...
                }} className = "cursor-pointer w-[30px] border border-red-700 rounded-full flex justify-center hover:bg-blue-500 hover:text-white duration-100 group" >
